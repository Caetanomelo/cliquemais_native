...
// committed). Falls back to the debug key when the file is absent (e.g. a
// fresh checkout without the secret) so `flutter run --release` still works.
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.cliquemais.cliquemais_native"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // flutter_tts requires minSdk 24 (uses APIs unavailable below that).
        minSdk = 24
