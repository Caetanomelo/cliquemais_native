...
/// Login/cadastro (email+senha) — mesmo par de campos e mesma mensagem de
/// erro do modal web (`src/supabase-client.js` + `auth-modal-js` em
/// `index.html`), só que como tela cheia em vez de modal, seguindo o padrão
/// de navegação do resto do app nativo.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(_signupMode ? 'Criar conta' : 'Entrar'),
      ),
      body: SafeArea(
        child: Padding(
...
class _AuthField extends StatelessWidget {
  ...
  const _AuthField({required this.controller, required this.hint, this.obscureText = false, this.keyboardType});
